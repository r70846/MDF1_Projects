...
//Function to display musician count in main view
- (void)displayCount
{
    if(musicianArray != nil)
    {
        NSString *count = [[NSString alloc] initWithFormat:@"%d", [musicianArray count]];
...
- (void)loadData
{
    ...
    musician11.notes = @"Hard to reach";
    ...
    musician16.notes = @"Plays too many notes";
